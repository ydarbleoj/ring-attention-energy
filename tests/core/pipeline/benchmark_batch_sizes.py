...
class BatchSizeBenchmark:
    ...
    def __init__(self):
        ...
        if not self.eia_api_key:
            raise ValueError("EIA_API_KEY not found in environment. Please set it in your .env file.")
        self.results = {}
    ...
    async def run_benchmark(self) -> Dict:
        ...
        batch_sizes_to_test = {
            "eia": [7, 14, 30, 60, 90],      # 1 week, 2 weeks, 1 month, 2 months, 3 months
    ...
    async def _create_collector(self, collector_name: str):
        ...
        if collector_name == "eia":
            ...
            return CAISOCollector(caiso_config)
        else:
...
async def main():
    ...
    try:
        ...
        print("EIA_API_KEY=your_actual_api_key")
    except Exception as e:
